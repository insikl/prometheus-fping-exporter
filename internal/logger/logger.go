...
// NOTE: Sets relative directory of code on log output for DEBUG and FATAL
func init() {
	// Find root once at startup by looking for go.mod
	dir, err := os.Getwd()
	if err != nil {
		// fall back to the full path in the log message.
		return
	}
